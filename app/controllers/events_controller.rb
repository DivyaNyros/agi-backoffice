...
def change_state_option
 @country_id=params[:country]
 if !['US','CA','DE'].include?(@country_id)
   @message = 'StatesNotSupported' 
end
render :partial =>'change_state_option' and return
end
# Method for updating the  country sate option end
  ...
  def duplicate
    ...
    @event.icontact_group = event.icontact_group
